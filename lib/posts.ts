...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      { p: ["Plug your numbers into the SnowLoadCalc calculator and it does all four steps and shows every factor. For gable, stepped and multi-level roofs, also check the unbalanced, drift and sliding cases — those can govern."] },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      { p: ["Some of the worst roof snow failures are not from uniform snow — they are from drifts that pile up where wind dumps snow against a taller wall, parapet or rooftop unit. ASCE 7 §7.7 covers these drift surcharge loads, and they often govern the design of a lower roof."] },
  ...
  },
  {
    ...
    body: [
      ...
      { h: "Density is everything", p: ["Fresh powder can be as light as 3–5 pounds per cubic foot, while old, wet, compacted snow approaches 20–30 pcf. ASCE 7 estimates settled snow density as γ = 0.13 × Pg + 14 psf-per-foot, capped at 30 pcf — higher ground snow loads come with denser snow."] },
  ...
  },
  {
    ...
    description: "Why metal roofs are 'slippery surfaces' in ASCE 7, how that lowers the slope factor, and the sliding-snow hazard to plan for.",
    ...
    body: [
      ...
      { h: "Don't forget the thermal factor", p: ["Many steel buildings are unheated, so they use Ct = 1.2 rather than 1.0 — that adds load and partly offsets the slippery benefit. Enter the real thermal condition, not an optimistic one."] },
  ...
  },
  {
    ...
    body: [
      ...
      { h: "Find your design load", p: ["Your structural drawings or local building department list the design ground/roof snow load. If you don't have them, compute the ASCE 7 design load for your location and roof here as a reasonable benchmark — most modern roofs are designed at least to the code value."] },
